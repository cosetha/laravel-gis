...
@section('content')
                <div class="container-fluid">
                        ...
                        <div class="row m-0">                        
                            ...
                            <form enctype="multipart/form-data" method="post" action="{{ url('') }}/dashboard/berita/update">
                                @csrf
                              
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="namaTempat">Judul Berita</label>
                                        <input type="text" class="form-control" id="namaTempat" placeholder="Judul Berita" name="judul" required value = "{{ $berita->judul }}">
                                    </div> 
                                </div>                                                          
